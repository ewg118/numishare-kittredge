...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="print">
		<div class="submenu">
			<div class="icon">
				<a href="{$display_path}display/{$source}/{$doc_id}.pdf">
					<img src="{$display_path}images/pdficon.png"/>
				</a>
			</div>
			<div class="icon">
				<a href="{$display_path}display/{$source}/{$doc_id}.xml">
					<img src="{$display_path}images/xml.png"/>
				</a>
			</div>
			<div class="icon">
				<a href="{$display_path}display/{$source}/{$doc_id}.rdf">
					<img src="{$display_path}images/rdf.gif" title="RDF" alt="PDF"/>
				</a>
			</div>
			<div class="icon">
				<a href="{$display_path}display/{$source}/{$doc_id}.atom">
